                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="page__title-content text-center">
                            <div class="page_title__bread-crumb">
                                <nav aria-label="breadcrumb">
                                    <nav aria-label="Breadcrumbs" class="breadcrumb-trail breadcrumbs">
                                        <ul>
                                            <li>
                                                <a href="{{url('/',app()->getLocale())}}"><span
                                                        style="color: #fff;">{{__('home')}}</span></a>
                                            </li>
                                            <li>
                            ...
                            <h3 class="breadcrumb-title breadcrumb-title-sd mt-30"
                                style="color: #fff!important;">{{__('news')}}</h3>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-xl-8 col-lg-8">
                        <div class="news-detalis-content mb-50">
                            ...
                            <p class="mt-25 mb-50"
                               style="color: #000!important;text-align:justify;">{!! nl2br($blog->first_body) !!}</p>
                            <div class="row">
                                ...
                                <div class="col-2 share-btn">
                                    <div class="btn-group" role="group">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li>
                                                <button class="dropdown-item">{!!$sharefacebook!!}</button>
                                            </li>
                                            <li>
                                                <button class="dropdown-item">{!!$sharetwitter!!}</button>
                                            </li>
                                            <li>
                                                <button class="dropdown-item">{!!$sharelink!!}</button>
                                            </li>
                                        </ul>
                                        </ul>
                                    </div>
