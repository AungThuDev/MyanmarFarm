        ...
        <ul class="pagination">
            ...
            @if ($paginator->onFirstPage())
                <li class="page-item disabled" aria-disabled="true" aria-label="@lang('pagination.previous')">
                    <span class="page-link" aria-hidden="true" style="padding-top:10px!important;padding-bottom:10px!important;"><i class="fas fa-chevron-left"></i></span>
                </li>
            @else
                <li class="page-item">
            ...
            @else
                <li class="page-item disabled" aria-disabled="true" aria-label="@lang('pagination.next')" >
                    <span class="page-link" aria-hidden="true" style="padding-top:10px!important;padding-bottom:10px!important;"><i class="fas fa-chevron-right"></i></span>
                </li>
            @endif
        </ul>
    </nav>
