               ...
               <div class="row grid">
                  ...
                  <div class="col-lg-4 col-md-6 c2 c3 c4 c5">
                      <div class="project-img mb-70">
                          <div class="inner-img"><a href="{{route('vacancies.detail',['id'=>$vacancy->id,'language'=>app()->getLocale()])}}"><img src="{{asset('assets/img/job.jpeg')}}" alt="Joyful Farmers at Myanmar Farm - Nurturing Growth" class="fluid"></a></div>
